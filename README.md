...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,126 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,136 | 🐛 44 | 🌐 Java | 📅 2026-09-18 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,634 | 🐛 1,476 | 🌐 Java | 📅 2026-09-18 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,526 | 🐛 2 | 🌐 Java | 📅 2026-09-19 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 11,000 | 🐛 0 | 🌐 Java | 📅 2026-09-18 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,944 | 🐛 488 | 🌐 Java | 📅 2026-09-19 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,792 | 🐛 863 | 🌐 Java | 📅 2026-09-18 -  Helps automatically find security vulnerabilities in your web applications.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,344 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-17 - A deliberately insecure Java Web Application.
