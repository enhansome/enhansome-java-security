...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,769 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,633 | 🐛 1,476 | 🌐 Java | 📅 2026-09-18 - A powerful and highly customizable authentication and access-control framework.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,996 | 🐛 0 | 🌐 Java | 📅 2026-09-18 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,943 | 🐛 489 | 🌐 Java | 📅 2026-09-16 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
* [Find Security Bugs](https://github.com/find-sec-bugs/find-sec-bugs/) ⭐ 2,447 | 🐛 115 | 🌐 Java | 📅 2026-03-26 - SpotBugs plugin for security audits of Java web applications and Android applications.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,788 | 🐛 863 | 🌐 Java | 📅 2026-09-18 -  Helps automatically find security vulnerabilities in your web applications.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,343 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-17 - A deliberately insecure Java Web Application.
