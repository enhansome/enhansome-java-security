...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,545 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,527 | 🐛 2 | 🌐 Java | 📅 2026-09-21 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 11,004 | 🐛 0 | 🌐 Java | 📅 2026-09-18 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,798 | 🐛 864 | 🌐 Java | 📅 2026-09-18 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,407 | 🐛 161 | 🌐 Java | 📅 2026-09-21 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,344 | 🐛 41 | 🌐 JavaScript | 📅 2026-09-21 - A deliberately insecure Java Web Application.
