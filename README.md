...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,806 | 🐛 100 | 📅 2026-06-30 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,114 | 🐛 44 | 🌐 Java | 📅 2026-07-24 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,603 | 🐛 1,453 | 🌐 Java | 📅 2026-08-17 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,519 | 🐛 3 | 🌐 Java | 📅 2026-08-17 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,899 | 🐛 1 | 🌐 Java | 📅 2026-08-15 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,922 | 🐛 496 | 🌐 Java | 📅 2026-08-17 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,623 | 🐛 854 | 🌐 Java | 📅 2026-08-17 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Cryptomator](https://github.com/cryptomator/cryptomator) ⭐ 15,898 | 🐛 283 | 🌐 Java | 📅 2026-08-01 - Multi-platform transparent client-side encryption of your files in the cloud.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,399 | 🐛 166 | 🌐 Java | 📅 2026-08-13 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,280 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-14 - A deliberately insecure Java Web Application.
