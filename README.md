...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,971 | 🐛 100 | 📅 2026-06-30 list thing.*
...
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,603 | 🐛 1,452 | 🌐 Java | 📅 2026-08-14 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,519 | 🐛 3 | 🌐 Java | 📅 2026-08-11 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,896 | 🐛 1 | 🌐 Java | 📅 2026-08-14 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,919 | 🐛 497 | 🌐 Java | 📅 2026-08-15 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,607 | 🐛 854 | 🌐 Java | 📅 2026-08-13 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Cryptomator](https://github.com/cryptomator/cryptomator) ⭐ 15,883 | 🐛 284 | 🌐 Java | 📅 2026-08-01 - Multi-platform transparent client-side encryption of your files in the cloud.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,278 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-14 - A deliberately insecure Java Web Application.
...
* [Encrypting with SSL/TLS](https://github.com/Hakky54/mutual-tls-ssl) ⭐ 638 | 🐛 2 | 🌐 Java | 📅 2026-08-13 Step by step guide for encrypting client and server communication
