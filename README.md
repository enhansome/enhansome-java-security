...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,326 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,636 | 🐛 1,482 | 🌐 Java | 📅 2026-09-23 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,527 | 🐛 2 | 🌐 Java | 📅 2026-09-22 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
* [OWASP ESAPI Java](https://github.com/ESAPI/esapi-java-legacy) ⭐ 648 | 🐛 133 | 🌐 Java | 📅 2026-09-18 - Enterprise Security API is a free, open source, web application security control library that makes it easier for programmers to write lower-risk applications.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 11,016 | 🐛 0 | 🌐 Java | 📅 2026-09-23 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,947 | 🐛 489 | 🌐 Java | 📅 2026-09-23 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
* [Find Security Bugs](https://github.com/find-sec-bugs/find-sec-bugs/) ⭐ 2,448 | 🐛 115 | 🌐 Java | 📅 2026-03-26 - SpotBugs plugin for security audits of Java web applications and Android applications.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,814 | 🐛 864 | 🌐 Java | 📅 2026-09-23 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,663 | 🐛 125 | 🌐 TypeScript | 📅 2026-09-23 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,409 | 🐛 162 | 🌐 Java | 📅 2026-09-23 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,347 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-23 - A deliberately insecure Java Web Application.
* [Security Shepherd](https://github.com/OWASP/SecurityShepherd) ⭐ 1,457 | 🐛 158 | 🌐 Java | 📅 2026-09-02 - Web and mobile application security training platform.
