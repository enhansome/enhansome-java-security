...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,958 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,132 | 🐛 43 | 🌐 Java | 📅 2026-09-03 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,623 | 🐛 1,456 | 🌐 Java | 📅 2026-09-04 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,522 | 🐛 4 | 🌐 Java | 📅 2026-09-04 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,951 | 🐛 0 | 🌐 Java | 📅 2026-09-03 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,933 | 🐛 503 | 🌐 Java | 📅 2026-09-04 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,733 | 🐛 860 | 🌐 Java | 📅 2026-09-03 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,655 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-04 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
