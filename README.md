...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,613 | 🐛 100 | 📅 2026-06-30 list thing.*
...
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,604 | 🐛 1,451 | 🌐 Java | 📅 2026-08-14 - A powerful and highly customizable authentication and access-control framework.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,894 | 🐛 1 | 🌐 Java | 📅 2026-08-13 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,598 | 🐛 854 | 🌐 Java | 📅 2026-08-13 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,637 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-14 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
