...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,469 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,626 | 🐛 1,448 | 🌐 Java | 📅 2026-09-09 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,523 | 🐛 2 | 🌐 Java | 📅 2026-09-09 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,963 | 🐛 0 | 🌐 Java | 📅 2026-09-08 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,939 | 🐛 487 | 🌐 Java | 📅 2026-09-09 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,749 | 🐛 860 | 🌐 Java | 📅 2026-09-09 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,407 | 🐛 162 | 🌐 Java | 📅 2026-09-09 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,327 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-07 - A deliberately insecure Java Web Application.
