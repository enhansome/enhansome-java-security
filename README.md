...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,839 | 🐛 105 | 📅 2026-08-21 list thing.*
...
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,618 | 🐛 1,476 | 🌐 Java | 📅 2026-08-28 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,522 | 🐛 2 | 🌐 Java | 📅 2026-08-28 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,927 | 🐛 492 | 🌐 Java | 📅 2026-08-27 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,696 | 🐛 858 | 🌐 Java | 📅 2026-08-27 -  Helps automatically find security vulnerabilities in your web applications.
