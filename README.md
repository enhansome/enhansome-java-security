...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 510,321 | 🐛 107 | 📅 2026-09-02 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,138 | 🐛 45 | 🌐 Java | 📅 2026-09-18 - Java JWT: JSON Web Token for Java and Android.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 11,025 | 🐛 1 | 🌐 Java | 📅 2026-09-25 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,947 | 🐛 491 | 🌐 Java | 📅 2026-09-25 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,826 | 🐛 862 | 🌐 Java | 📅 2026-09-24 -  Helps automatically find security vulnerabilities in your web applications.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,353 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-24 - A deliberately insecure Java Web Application.
