...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,493 | 🐛 104 | 📅 2026-08-21 list thing.*
...
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,606 | 🐛 1,447 | 🌐 Java | 📅 2026-08-21 - A powerful and highly customizable authentication and access-control framework.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,914 | 🐛 0 | 🌐 Java | 📅 2026-08-20 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,653 | 🐛 855 | 🌐 Java | 📅 2026-08-20 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,399 | 🐛 168 | 🌐 Java | 📅 2026-08-21 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
