...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,921 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,134 | 🐛 43 | 🌐 Java | 📅 2026-09-03 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,625 | 🐛 1,463 | 🌐 Java | 📅 2026-09-07 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,522 | 🐛 2 | 🌐 Java | 📅 2026-09-07 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,959 | 🐛 0 | 🌐 Java | 📅 2026-09-04 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,936 | 🐛 490 | 🌐 Java | 📅 2026-09-07 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
* [Find Security Bugs](https://github.com/find-sec-bugs/find-sec-bugs/) ⭐ 2,442 | 🐛 115 | 🌐 Java | 📅 2026-03-26 - SpotBugs plugin for security audits of Java web applications and Android applications.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,747 | 🐛 861 | 🌐 Java | 📅 2026-09-03 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Cryptomator](https://github.com/cryptomator/cryptomator) ⭐ 16,101 | 🐛 284 | 🌐 Java | 📅 2026-09-07 - Multi-platform transparent client-side encryption of your files in the cloud.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,407 | 🐛 163 | 🌐 Java | 📅 2026-09-07 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,321 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-07 - A deliberately insecure Java Web Application.
