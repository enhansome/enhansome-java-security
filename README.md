...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,178 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,135 | 🐛 43 | 🌐 Java | 📅 2026-09-03 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,625 | 🐛 1,466 | 🌐 Java | 📅 2026-09-08 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,522 | 🐛 2 | 🌐 Java | 📅 2026-09-08 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,961 | 🐛 0 | 🌐 Java | 📅 2026-09-07 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,938 | 🐛 484 | 🌐 Java | 📅 2026-09-08 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,746 | 🐛 860 | 🌐 Java | 📅 2026-09-08 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,656 | 🐛 134 | 🌐 TypeScript | 📅 2026-09-08 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,407 | 🐛 163 | 🌐 Java | 📅 2026-09-08 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,324 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-07 - A deliberately insecure Java Web Application.
