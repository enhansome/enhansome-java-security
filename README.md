...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,664 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,629 | 🐛 1,444 | 🌐 Java | 📅 2026-09-11 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,523 | 🐛 1 | 🌐 Java | 📅 2026-09-12 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,979 | 🐛 0 | 🌐 Java | 📅 2026-09-12 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,941 | 🐛 483 | 🌐 Java | 📅 2026-09-11 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,765 | 🐛 862 | 🌐 Java | 📅 2026-09-10 -  Helps automatically find security vulnerabilities in your web applications.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,335 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-13 - A deliberately insecure Java Web Application.
