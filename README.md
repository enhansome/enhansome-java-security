...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,364 | 🐛 105 | 📅 2026-08-21 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,121 | 🐛 43 | 🌐 Java | 📅 2026-08-24 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,615 | 🐛 1,460 | 🌐 Java | 📅 2026-08-26 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,521 | 🐛 1 | 🌐 Java | 📅 2026-08-27 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,932 | 🐛 0 | 🌐 Java | 📅 2026-08-26 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,925 | 🐛 493 | 🌐 Java | 📅 2026-08-27 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,689 | 🐛 859 | 🌐 Java | 📅 2026-08-27 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,401 | 🐛 165 | 🌐 Java | 📅 2026-08-27 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,293 | 🐛 39 | 🌐 JavaScript | 📅 2026-08-24 - A deliberately insecure Java Web Application.
