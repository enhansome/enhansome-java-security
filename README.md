...
* [OWASP ESAPI Java](https://github.com/ESAPI/esapi-java-legacy) ⭐ 648 | 🐛 134 | 🌐 Java | 📅 2026-09-18 - Enterprise Security API is a free, open source, web application security control library that makes it easier for programmers to write lower-risk applications.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,356 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-24 - A deliberately insecure Java Web Application.
