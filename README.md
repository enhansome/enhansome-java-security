...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,355 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,628 | 🐛 1,443 | 🌐 Java | 📅 2026-09-11 - A powerful and highly customizable authentication and access-control framework.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,976 | 🐛 0 | 🌐 Java | 📅 2026-09-11 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Find Security Bugs](https://github.com/find-sec-bugs/find-sec-bugs/) ⭐ 2,444 | 🐛 115 | 🌐 Java | 📅 2026-03-26 - SpotBugs plugin for security audits of Java web applications and Android applications.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,764 | 🐛 862 | 🌐 Java | 📅 2026-09-10 -  Helps automatically find security vulnerabilities in your web applications.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,332 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-10 - A deliberately insecure Java Web Application.
