...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,749 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,137 | 🐛 42 | 🌐 Java | 📅 2026-09-03 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,626 | 🐛 1,446 | 🌐 Java | 📅 2026-09-10 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,523 | 🐛 2 | 🌐 Java | 📅 2026-09-10 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,966 | 🐛 0 | 🌐 Java | 📅 2026-09-09 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,940 | 🐛 485 | 🌐 Java | 📅 2026-09-10 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
* [Find Security Bugs](https://github.com/find-sec-bugs/find-sec-bugs/) ⭐ 2,443 | 🐛 115 | 🌐 Java | 📅 2026-03-26 - SpotBugs plugin for security audits of Java web applications and Android applications.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,758 | 🐛 860 | 🌐 Java | 📅 2026-09-10 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,660 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-10 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,331 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-10 - A deliberately insecure Java Web Application.
