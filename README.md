...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,834 | 🐛 105 | 📅 2026-08-21 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,120 | 🐛 44 | 🌐 Java | 📅 2026-07-24 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,608 | 🐛 1,450 | 🌐 Java | 📅 2026-08-21 - A powerful and highly customizable authentication and access-control framework.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,917 | 🐛 0 | 🌐 Java | 📅 2026-08-21 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,660 | 🐛 856 | 🌐 Java | 📅 2026-08-21 -  Helps automatically find security vulnerabilities in your web applications.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,286 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-14 - A deliberately insecure Java Web Application.
