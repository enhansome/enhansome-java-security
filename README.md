...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 497,217 | 🐛 104 | 📅 2026-06-30 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,115 | 🐛 44 | 🌐 Java | 📅 2026-07-24 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,603 | 🐛 1,456 | 🌐 Java | 📅 2026-08-18 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,519 | 🐛 5 | 🌐 Java | 📅 2026-08-18 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,902 | 🐛 1 | 🌐 Java | 📅 2026-08-17 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,922 | 🐛 497 | 🌐 Java | 📅 2026-08-18 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,632 | 🐛 854 | 🌐 Java | 📅 2026-08-17 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,641 | 🐛 137 | 🌐 TypeScript | 📅 2026-08-18 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
...
* [Cryptomator](https://github.com/cryptomator/cryptomator) ⭐ 15,907 | 🐛 284 | 🌐 Java | 📅 2026-08-01 - Multi-platform transparent client-side encryption of your files in the cloud.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,399 | 🐛 166 | 🌐 Java | 📅 2026-08-18 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,282 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-14 - A deliberately insecure Java Web Application.
