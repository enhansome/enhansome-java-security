...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,914 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,137 | 🐛 44 | 🌐 Java | 📅 2026-09-18 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,635 | 🐛 1,481 | 🌐 Java | 📅 2026-09-21 - A powerful and highly customizable authentication and access-control framework.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 11,010 | 🐛 0 | 🌐 Java | 📅 2026-09-21 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,946 | 🐛 488 | 🌐 Java | 📅 2026-09-19 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,804 | 🐛 865 | 🌐 Java | 📅 2026-09-22 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,408 | 🐛 161 | 🌐 Java | 📅 2026-09-22 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,346 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-22 - A deliberately insecure Java Web Application.
