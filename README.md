...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,992 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,136 | 🐛 43 | 🌐 Java | 📅 2026-09-03 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,628 | 🐛 1,449 | 🌐 Java | 📅 2026-09-14 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,524 | 🐛 1 | 🌐 Java | 📅 2026-09-14 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
* [OWASP ESAPI Java](https://github.com/ESAPI/esapi-java-legacy) ⭐ 648 | 🐛 132 | 🌐 Java | 📅 2026-09-07 - Enterprise Security API is a free, open source, web application security control library that makes it easier for programmers to write lower-risk applications.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,982 | 🐛 0 | 🌐 Java | 📅 2026-09-12 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,940 | 🐛 486 | 🌐 Java | 📅 2026-09-11 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
* [Find Security Bugs](https://github.com/find-sec-bugs/find-sec-bugs/) ⭐ 2,445 | 🐛 115 | 🌐 Java | 📅 2026-03-26 - SpotBugs plugin for security audits of Java web applications and Android applications.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,766 | 🐛 863 | 🌐 Java | 📅 2026-09-14 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Cryptomator](https://github.com/cryptomator/cryptomator) ⭐ 16,126 | 🐛 284 | 🌐 Java | 📅 2026-09-12 - Multi-platform transparent client-side encryption of your files in the cloud.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,407 | 🐛 162 | 🌐 Java | 📅 2026-09-10 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
* [Keyczar](https://github.com/google/keyczar) ⚠️ Archived - Easy-to-use crypto toolkit by Google.
* [ACME4J](https://github.com/shred/acme4j) ⭐ 592 | 🐛 7 | 🌐 Java | 📅 2026-08-03 - Java ACME client for issuing X.509 certificates using Let's Encrypt or another ACME based CA.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,335 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-14 - A deliberately insecure Java Web Application.
* [Security Shepherd](https://github.com/OWASP/SecurityShepherd) ⭐ 1,458 | 🐛 148 | 🌐 Java | 📅 2026-09-02 - Web and mobile application security training platform.
...
* [Encrypting with SSL/TLS](https://github.com/Hakky54/mutual-tls-ssl) ⭐ 636 | 🐛 0 | 🌐 Java | 📅 2026-09-03 Step by step guide for encrypting client and server communication
