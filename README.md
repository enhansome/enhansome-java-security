...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,304 | 🐛 105 | 📅 2026-09-02 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,128 | 🐛 44 | 🌐 Java | 📅 2026-08-24 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,622 | 🐛 1,483 | 🌐 Java | 📅 2026-09-02 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,522 | 🐛 2 | 🌐 Java | 📅 2026-09-02 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,945 | 🐛 0 | 🌐 Java | 📅 2026-09-02 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,930 | 🐛 502 | 🌐 Java | 📅 2026-09-02 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,720 | 🐛 859 | 🌐 Java | 📅 2026-09-01 -  Helps automatically find security vulnerabilities in your web applications.
...
* [Conscrypt](https://github.com/google/conscrypt) ⭐ 1,406 | 🐛 162 | 🌐 Java | 📅 2026-09-02 - Java Security Provider that implements parts of the Java Cryptography Extension and Java Secure Socket Extension.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,318 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-31 - A deliberately insecure Java Web Application.
