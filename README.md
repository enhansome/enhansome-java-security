...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,627 | 🐛 105 | 📅 2026-09-02 list thing.*
...
* [JJWT](https://github.com/jwtk/jjwt) ⭐ 11,130 | 🐛 44 | 🌐 Java | 📅 2026-08-24 - Java JWT: JSON Web Token for Java and Android.
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,621 | 🐛 1,484 | 🌐 Java | 📅 2026-09-02 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,522 | 🐛 3 | 🌐 Java | 📅 2026-09-03 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,949 | 🐛 0 | 🌐 Java | 📅 2026-09-02 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,931 | 🐛 501 | 🌐 Java | 📅 2026-09-02 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,730 | 🐛 859 | 🌐 Java | 📅 2026-09-03 -  Helps automatically find security vulnerabilities in your web applications.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,317 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-31 - A deliberately insecure Java Web Application.
* [Security Shepherd](https://github.com/OWASP/SecurityShepherd) ⭐ 1,456 | 🐛 147 | 🌐 Java | 📅 2026-09-02 - Web and mobile application security training platform.
