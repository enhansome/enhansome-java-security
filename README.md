...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,834 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Spring Security](https://github.com/spring-projects/spring-security) ⭐ 9,637 | 🐛 1,485 | 🌐 Java | 📅 2026-09-24 - A powerful and highly customizable authentication and access-control framework.
...
* [PAC4J](https://github.com/pac4j/pac4j) ⭐ 2,528 | 🐛 2 | 🌐 Java | 📅 2026-09-24 - Security engine for Java to authenticate users, get their profiles and manage authorizations in order to secure web applications and web services.
...
* [Sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 11,021 | 🐛 0 | 🌐 Java | 📅 2026-09-23 - SonarQube provides the capability to show the health of an application and highlight newly introduced issues.
...
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,947 | 🐛 488 | 🌐 Java | 📅 2026-09-24 - SpotBugs is FindBugs' successor. A tool for static analysis to look for bugs in Java code.
...
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,822 | 🐛 862 | 🌐 Java | 📅 2026-09-24 -  Helps automatically find security vulnerabilities in your web applications.
...
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,352 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-24 - A deliberately insecure Java Web Application.
